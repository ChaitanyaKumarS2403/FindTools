...
| S.No | Application | Description |
| :-- | :--- | :--- |
| 1 | **[Aloha Browser](https://alohabrowser.app/download.html)** | A privacy-focused browser featuring a built-in VPN and ad-blocker. |
| 2 | **[LocalSend](https://localsend.org/download)** | An open-source tool for sharing files over a local network without internet. |
